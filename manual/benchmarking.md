...
| **Accessibility**       | ![todos accessibility](/images/benchmarking/audit/todos_access.png)          | - Form elements do not have associated labels: add <code>type="text"</code> to the <code>input</code> element in index.html                                                                           |
